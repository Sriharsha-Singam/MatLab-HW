...
%
% Test Cases:
%      [ans] = isequal(passwordProtec('friendOrfoe?'),passwordProtec_soln('friendOrfoe?'))
%     [out1] = passwordProtec('friendOrfoe?')
% 	out1 =>    0
% 
%    [out2] = passwordProtec('foe')
% 	out1 =>    0
% 
%    [out3] = passwordProtec('protecM3Friend!!')
% 	out1 =>    1
%
%--------------------------------------------------------------------------------
...
%
% Test Cases:
%        [ans] = isequal(suspects('ND WF RW OT EF HT MA ', [true true false false false false true]),suspects_soln('ND WF RW OT EF HT MA ', [true true false false false false true]))
%        [ans1] = isequal(suspects('HH TA PK ZT ', [true true true false]),suspects_soln('HH TA PK ZT ', [true true true false]))
...
%
% Test Cases:
%      [ans] = isequal(lockSMITH([123123 1 48 12 35 123 49 213 24 111 210], [9 -33 123 300 -15], [true false true false true]),lockSMITH_soln([123123 1 48 12 35 123 49 213 24 111 210], [9 -33 123 300 -15], [true false true false true]))
...
%
% Test Cases:
%        [ans] = isequal(superheroCrisis([24,25,1,25,25], [1,15,2,4,6], [17,70,6,30,40]),superheroCrisis_soln([24,25,1,25,25], [1,15,2,4,6], [17,70,6,30,40]))
...
%    [ans] = isequal(criminalMinds([true false false], [true false true], [true false true], [true false true]),criminalMinds_soln([true false false], [true false true], [true false true], [true false true]))
%     [ans3] = isequal(criminalMinds([false false false false false], [false false false false false], [false false false false false], [false true false false false]),criminalMinds_soln([false false false false false], [false false false false false], [false false false false false], [false true false false false]))
